    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c1Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(StudentActivity2.this);
        ...
        bBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder bBuilder = new AlertDialog.Builder(StudentActivity2.this);
        ...
        semBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder semBuilder = new AlertDialog.Builder(StudentActivity2.this);
        ...
        Button button = (Button) findViewById(R.id.search_book);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(StudentActivity2.this,downloadActivity.class);
                startActivity(i);
            }
        });
    }
